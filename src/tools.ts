    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          followups: {
            type: "array",
            description: "2 a 4 preguntas cortas de seguimiento (maximo 80 caracteres cada una) que el cliente podria querer hacer despues, partiendo de tus insights y recomendaciones: profundizaciones ('¿Que tableros tienen peor factor de potencia?'), cuantificacion de ahorro ('¿Cuanto ahorraria corrigiendo el factor de potencia?') o comparaciones temporales. Deben responderse con las herramientas disponibles, sin revelar ids internos.",
            items: { type: "string" },
          },
          cards: {
            type: "array",
